  ...
  return `
    ...
    <footer class="site-footer">
      <div class="foot-inner">
        ...
        <div class="foot-by">Built by <a href="https://benrichardson.dev/" target="_blank" rel="noopener">benrichardson.dev</a> · Data ${new Date(data.meta.generatedAt).toLocaleDateString('en-AU', { month: 'short', year: 'numeric' })}</div>
      </div>
    </footer>`;
}
